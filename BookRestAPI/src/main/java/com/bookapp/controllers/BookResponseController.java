...
public class BookResponseController {
	...
	public ResponseEntity<List<Book>> showAllBooks(){
		...
		ResponseEntity entity = new ResponseEntity<List<Book>>(bookList, HttpStatus.OK);
		return entity;
	}
	...
	public ResponseEntity<List<Book>> showBooksByAuthor(@PathVariable("author")String author){
		...
		ResponseEntity entity = new ResponseEntity<List<Book>>(bookList,header, HttpStatus.OK);
		return entity; 
	}
	...
	public ResponseEntity<Book> showBooksById(@PathVariable("bookId")int id){
